    ...
    <div className="w-full flex flex-col items-center">
      ...
      {selectedAction === 'block' && (
        <div className="w-full max-w-sm mt-4 flex flex-col items-center animate-fade-in">
          ...
          <button
            onClick={onComplete}
            className="w-full py-3 px-6 rounded-xl font-cyber font-bold text-xs uppercase tracking-wider bg-gradient-to-r from-cyber-green to-cyber-cyan text-black shadow-glow-green hover:brightness-110 active:scale-95 transition-all flex items-center justify-center gap-2"
          >
